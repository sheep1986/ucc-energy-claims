  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-navy via-navy-light to-navy flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          <div className="bg-emerald w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6">
            <IconCircleCheck className="w-12 h-12 text-white" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Thank You!
          </h1>
          <h2 className="text-2xl text-ice mb-6">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 mb-8">
          ...
          <div className="space-y-4 text-left">
            <div className="flex items-start">
              <div className="bg-emerald/20 w-8 h-8 rounded-full flex items-center justify-center mr-4 mt-1 flex-shrink-0">
        ...
        <div className="mt-8 text-white/60 text-sm">
          <p>
            ...
            <a href="mailto:hello@utilitycommissionclaims.co.uk" className="text-ice hover:text-white">
