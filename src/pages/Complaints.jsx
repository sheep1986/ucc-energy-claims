        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              <IconMessageCircle className="w-4 h-4 text-ice mr-2" />
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
            <h2 className="text-2xl font-bold text-navy mb-6">How to Make a Complaint</h2>
            
            <div className="space-y-8">
              {/* Step 1 */}
              <div className="relative">
                <div className="flex items-start">
                  <div className="bg-emerald text-white w-10 h-10 rounded-full flex items-center justify-center font-bold mr-4 flex-shrink-0">
                    1
                  </div>
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-navy mb-3">Contact Us</h3>
                    <div className="bg-gray-50 p-6 rounded-lg">
                      <div className="space-y-3">
                        <div className="flex items-center">
                          <IconMail className="w-5 h-5 text-emerald mr-3" />
                      ...
                      <div className="mt-4 border-t pt-4">
                        <p className="font-semibold text-navy mb-2">Please Include:</p>
              ...
              <div className="relative">
                <div className="flex items-start">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-navy mb-3">Our Response Timeline</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <IconClock className="w-6 h-6 text-emerald mb-2" />
                        <div className="font-semibold text-navy">Acknowledgment</div>
                        <div className="text-gray-600">Within 48 hours</div>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <IconCircleCheck className="w-6 h-6 text-emerald mb-2" />
                        <div className="font-semibold text-navy">Investigation</div>
                        <div className="text-gray-600">We'll review your case</div>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <IconClock className="w-6 h-6 text-emerald mb-2" />
                        <div className="font-semibold text-navy">Initial Response</div>
                        <div className="text-gray-600">Within 7 days</div>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                        <IconCircleCheck className="w-6 h-6 text-emerald mb-2" />
                        <div className="font-semibold text-navy">Final Resolution</div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-navy mb-3">Internal Escalation</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-navy mb-3">External Options</h3>
                <p className="text-gray-600 mb-4">
                  If you remain unsatisfied after our final response, you may contact:
                </p>
                <div className="space-y-3">
                  <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                    <IconExternalLink className="w-5 h-5 text-emerald mt-1 mr-3 flex-shrink-0" />
                    <div>
                      <div className="font-semibold text-navy">Financial Ombudsman Service</div>
                  ...
                  <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                    <IconExternalLink className="w-5 h-5 text-emerald mt-1 mr-3 flex-shrink-0" />
                    <div>
                      <div className="font-semibold text-navy">Trading Standards</div>
                  ...
                  <div className="flex items-start p-4 bg-gray-50 rounded-lg">
                    <IconExternalLink className="w-5 h-5 text-emerald mt-1 mr-3 flex-shrink-0" />
                    <div>
                      <div className="font-semibold text-navy">Information Commissioner's Office</div>
          ...
          <div className="bg-gradient-to-br from-navy to-navy-light rounded-xl p-8 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start">
                <IconCircleCheck className="w-6 h-6 text-emerald mt-1 mr-3 flex-shrink-0" />
                <div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 mt-8">
            <h2 className="text-2xl font-bold text-navy mb-6">Common Complaint Categories</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border-l-4 border-emerald pl-4">
                <h3 className="font-semibold text-navy">Service Quality</h3>
                <p className="text-gray-600 text-sm">Response times, communication issues</p>
              </div>
              <div className="border-l-4 border-emerald pl-4">
                <h3 className="font-semibold text-navy">Claim Progress</h3>
                <p className="text-gray-600 text-sm">Delays or lack of updates</p>
              </div>
              <div className="border-l-4 border-emerald pl-4">
                <h3 className="font-semibold text-navy">Fee Disputes</h3>
                <p className="text-gray-600 text-sm">Questions about our success fee</p>
              </div>
              <div className="border-l-4 border-emerald pl-4">
                <h3 className="font-semibold text-navy">Data Concerns</h3>
