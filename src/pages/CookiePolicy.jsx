        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              <IconCookie className="w-4 h-4 text-ice mr-2" />
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
              <h2 className="text-2xl font-bold text-navy mb-6">Cookies We Use</h2>
              
              <div className="space-y-6">
                <div className="border-l-4 border-emerald pl-6">
                  <h3 className="text-xl font-semibold text-navy mb-2">
                    <IconShield className="inline w-5 h-5 text-emerald mr-2" />
                ...
                <div className="border-l-4 border-ice pl-6">
                  <h3 className="text-xl font-semibold text-navy mb-2">
                    <IconInfoCircle className="inline w-5 h-5 text-ice mr-2" />
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 mb-8">
              <h2 className="text-2xl font-bold text-navy mb-6">
                <IconSettings className="inline w-6 h-6 text-navy mr-2" />
                Managing Cookies
              </h2>
              
              <div className="space-y-4">
                <div>
                  <h3 className="text-lg font-semibold text-navy mb-2">Your Cookie Choices</h3>
                  <div className="bg-gray-50 p-4 rounded-lg space-y-2">
                    <div className="flex items-start">
                      <span className="text-emerald font-semibold mr-2">Accept All:</span>
                      <span className="text-gray-600">Full functionality and analytics to improve our service</span>
                    </div>
                    <div className="flex items-start">
                      <span className="text-emerald font-semibold mr-2">Essential Only:</span>
                      <span className="text-gray-600">Basic website functionality only</span>
                    </div>
                    <div className="flex items-start">
                      <span className="text-emerald font-semibold mr-2">Custom:</span>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-navy mb-2">How to Control Cookies</h3>
                  <ul className="list-disc pl-5 text-gray-600 space-y-2">
